...
//                .exceptionHandling(e -> e.authenticationEntryPoint(myEntryPoint).configure(http))
//
//        ;
//
...
//                .exceptionHandling(exceptionHandlingConfigurer -> exceptionHandlingConfigurer.authenticationEntryPoint(myEntryPoint));
//
//
//        return http.build();
//    }
