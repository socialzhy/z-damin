...
) ENGINE=InnoDB AUTO_INCREMENT=100004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='权限';
...
INSERT INTO `system_permission` (`id`, `method`, `path`, `type`, `parent_id`, `access_level`, `name`, `description`, `create_by`, `create_time`, `update_by`, `update_time`, `deleted`) VALUES (10001, 'POST', '/login', 2, 11, 1, '登录', '登录', 0, '2023-01-06 17:19:30', 0, '2023-01-06 17:19:30', 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色权限关联';
