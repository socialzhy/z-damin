...
-- ----------------------------
BEGIN;
INSERT INTO `system_user` (`id`, `mobile`, `email`, `username`, `password`, `name`, `create_by`, `create_time`, `update_by`, `update_time`, `is_disabled`, `is_deleted`) VALUES (1, '1', '1', 'admin', '$2a$10$X8ZDTDnUzwXhJIjEzzN1Y.5/HJMjDTPj/bUEsbSXNOsyPMddMNrGC', '1', 1111, '2022-12-22 15:27:23', 1111, '2022-12-22 15:27:23', 0, 0);
